...
public class ArffLoader {
            ...
            while (numAttribute == 0 && streamTokenizer.ttype != StreamTokenizer.TT_EOF) {
                ...
                while (streamTokenizer.ttype != StreamTokenizer.TT_EOL
                    ...
                    if (streamTokenizer.ttype == StreamTokenizer.TT_NUMBER) {
                        ...
                        boolean isNumeric = auxAttributes.get(numAttribute).isNumeric();
                        double value;
                        if ("?".equals(streamTokenizer.sval)) {
                            ...
                            value = auxAttributes.get(numAttribute).indexOfValue(
    ...
    protected void setValue(Instance instance, int numAttribute, double value, boolean isNumber) {
        ...
        if (isNumber && auxAttributes.get(numAttribute).isNominal) {
            valueAttribute = auxAttributes.get(numAttribute).indexOfValue(Double.toString(value));
                ...
                while (streamTokenizer.ttype != '}') {
                    ...
                    if (streamTokenizer.ttype == StreamTokenizer.TT_NUMBER) {
                        ...
                        if (this.auxAttributes.get(numAttribute).isNumeric()) {
                            ...
                            this.setSparseValue(instance, indexValues, attributeValues, numAttribute, auxAttributes.get(numAttribute).indexOfValue(streamTokenizer.sval), false);
                        }
                    }
                    streamTokenizer.nextToken();
                }
                ...
                while (streamTokenizer.ttype != '}') {
                    ...
                    if (streamTokenizer.ttype == StreamTokenizer.TT_NUMBER) {
                        ...
                        //numAttribute++;
                            ...
                            || streamTokenizer.ttype == 34)) {
                        //System.out.print(streamTokenizer.sval + "/"+auxAttributes.get(numAttribute).indexOfValue(streamTokenizer.sval)+" ");
                        if (this.auxAttributes.get(numAttribute).isNumeric()) {
                            this.setValue(instance, numAttribute, Double.valueOf(streamTokenizer.sval).doubleValue(), true);
                        } else {
                            this.setValue(instance, numAttribute, auxAttributes.get(numAttribute).indexOfValue(streamTokenizer.sval), false);
                            //numAttribute++;
                        }
                    }
                    streamTokenizer.nextToken();
